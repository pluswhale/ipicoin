...
<template>
    <div 
     ...
     >
        <h2 class="text-white uppercase text-[40px] font-[700] font-['Big_Shoulders_Stencil_Text'] mb-[77px] translate-y-[2px] translate-x-[-5px]">Perhaps the best project in web 3.0</h2>
        ...
        <div class="flex gap-[64px] mt-[50px]">
