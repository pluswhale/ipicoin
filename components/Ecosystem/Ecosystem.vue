...
<template>
    <div 
        ...
        class="flex flex-col items-center w-full mt-[140px] max-w-[1400px] mx-auto my-0 translate-x-[-10px] max-[1420px]:mt-[90px]" 
    >
        <h2 class="text-white uppercase text-[40px] font-[700] font-['Big_Shoulders_Stencil_Text'] mb-[42px] max-[1420px]:text-[22px]">ecosystem</h2>

        <!-- -------------desktop version--------------- -->
        <div class="flex flex-col max-w-[1068px] justify-between max-[1420px]:hidden">
            <!--top part-->
            ...
            <div class="flex flex-col translate-y-[-90px] ">
                ...
                <div class="flex relative translate-y-[190px]">
                    ...
                    <img src="../../assets/images/platform/arrow7(1).svg" class="translate-y-[-215px] translate-x-[620px] " alt="">
                </div>
                <!--bottom arrow-->
                
                <!--bottom block-->
                <div class="flex bg-[#749CC733]/20 rounded-[20px] h-[60px] translate-x-[30px] translate-y-[-5px] justify-center relative w-[1005px]">
        ...
        <!-- -------------mobile version --------------- -->
        <div class="hidden flex-col w-[310px] relative justify-between max-[1420px]:flex ">
            <!--arrows-->            
