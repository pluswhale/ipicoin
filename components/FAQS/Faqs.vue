...
<div 
  ...
  >
    <div class="flex flex-col items-center h-[950px] w-full mt-[136px] max-w-[1360px] mx-auto my-0">
        ...
        <div class="flex w-[1094px] border-b-[4px] border-b-[#749DCA] h-[100px] justify-center mb-[61px] max-[1200px]:w-[892px] max-[1200px]:h-[80px]">
        ...
        <div class="flex w-[994px] min-h-[358px] max-[1200px]:w-[892px]">
