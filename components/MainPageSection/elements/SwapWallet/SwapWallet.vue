    ...
    <div class="flex flex-col translate-x-[-10px] relative">
        ...
        'w-[471px]':!isMobile,'w-[343px]':isMobile, 'mt-[119px]':!isMobile,'mt-[75px]':isMobile,'px-[50px]':!isMobile, 'px-[25px]':isMobile,'py-[28px]':!isMobile, 'py-[20px]':isMobile,}">
            <div class="flex flex-col w-full">
                ...
                <!--button connect-->
                <button class="rounded-[20px] justify-center items-center bg-[#EC474E] text-white uppercase" :class="{'h-[46px]':!isMobile,'h-[34px]':isMobile,'text-[21px]':!isMobile,'text-[14px]':isMobile,'font-[700px]':!isMobile,'font-[500]':isMobile,'font-[Barlow]':!isMobile,'font-[Inter]':isMobile,'leading-[27px]':!isMobile, 'leading-[8px]':isMobile,'mt-[22px]':!isMobile, 'mt-[16px]':isMobile,}">connect wallet</button>
                <!--button connect-->
