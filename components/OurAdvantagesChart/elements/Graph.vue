<template>
    <div 
        class=" graph_wrap  max-[1420px]:hidden" 
        ref="cardRef"
    ...
    <!-- for Mobile -->
      <div class=" w-[343px] h-[630px] hidden max-[1420px]:flex max-[1420px]:flex-col" >
            <div
...
import {dynamicColumnsInTable, generateTextCoinInSwitch, generateIconInSwitch} from './ForMobile/Graph1/constants';
