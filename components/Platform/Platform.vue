    <template>
        ...
        y: -100,
         ...
         >
            <div class="flex flex-col items-center w-full mt-[30px] h-[900px]  max-w-[1400px] mx-auto my-0 md:mt-[80px] sm:h-[750px]">
                <h2 class="text-white uppercase text-[40px] font-[700] font-['Big_Shoulders_Stencil_Text'] mb-[15px] lg:text-[26px]">platform</h2>
                <div class="flex w-[994px] border-b-[3px] border-b-[#749DCA] h-[100px] justify-center mb-[61px] lg:w-[833px] lg:h-[80px] md:w-[553px] md:h-[60px] md:mb-[20px]">
