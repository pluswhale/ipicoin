<template>
    <div class="flex flex-col  mt-[43px] mx-[auto] relative">
                ...
                <div class="flex flex-col">
                    <div  class="flex items-center justify-between pl-[10px] py-[5px] pr-[30px] w-full border-[1px] rounded-[8px] mb-[10px]">
                        <div class="flex items-center">
                            <span class="text-white font-[500] text-[11px] mr-[10px] mt-[5px] font-['Inter']">From</span>
                            <span class="text-[#749DCA] font-[500] text-[17px] uppercase font-['Inter']">ipicoin</span>
                        </div>
                       <input type="text" maxlength="10"  placeholder="0" class="outline-none bg-[transparent] text-white font-[700] text-[17px] font-['Inter'] w-[100px] placeholder:text-[17px] text-right">
                    </div>
                    <div class="flex items-center justify-between pl-[10px] py-[5px] pr-[30px] w-full border-[1px] rounded-[8px]">
                        <div class="flex items-center relative">
                            ...
                            <span class="text-[#749DCA] font-[500] translate-x-[30px] font-['Inter'] text-[17px] uppercase">usd</span>
                            ...
                            <div v-if="state.toDialogOpen" class="absolute w-[270px] left-[-10px] top-[40px] bg-white/10 border-[1px] border-[white] backdrop-blur-sm  rounded-[8px]">
